...
const PropertyCards = ({
  ...
  return (
    ...
    >
      {/* Image Section */}
      <Box
        className="prop-card-img-section"
      >
        {getStatusBadge()}
      ...
      {/* Content Section */}
      <Box
        className="prop-card-content-sec"      >
        {/* Title */}
        <h5
          className="prop-card-heading"
        >
          {Heading}
        </h5>
        ...
        <Link to={`/property/${propertyId}`} style={{ textDecoration: "none",display:"flex",justifyContent:"flex-end" }}>
          <button
